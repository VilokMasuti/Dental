      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={logoContainer}>
            <Img
              src="https://www.vecteezy.com/vector-art/43116568-peacock-feather-watercolor-illustration-hand-drawn-painting-isolated-on-white-background-indigo-blue-monochrome-beauty-and-wealth-symbol-for-fashion-clothes-tattoos-printing-and-pattern-designs"
              width="50"
              height="50"
              alt="DentWise"
              style={logo}
          ...
          <Text style={text}>Hare Krishna,</Text>
