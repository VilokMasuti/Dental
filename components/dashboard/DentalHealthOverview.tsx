...
import { getUserAppointmentStats } from '@/lib/ServerActions/appointments';
...
async function DentalHealthOverview() {
  ...
  return (
    <Card className="lg:col-span-2 font-[Harmattan] textbg " >
      <CardHeader>
      ...
      <CardContent>
        <div className="grid md:grid-cols-3 gap-6 font-[Harmattan] ">
        ...
        <div className="mt-6 p-4 bg-gradient-to-r from-primary/10 to-primary/5 rounded-xl border border-primary/20">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold  mb-1 textbg ">Ready to get started?</h4>
