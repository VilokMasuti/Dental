...
export default function MainActions() {
  return (
    <div className="grid md:grid-cols-2 gap-8 mb-12 font-[Harmattan] textbg ">
      {/* AI Voice Assistant */}
      <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30">
        ...
        <CardContent className="relative p-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-2 textbg " >AI Voice Assistant</h3>
          ...
          <Link
            ...
            className={buttonVariants({
              variant: "outline",
              className:
                "w-full mt-6 hover:to-primary/70  bg-black text-amber-50 font-semibold py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300",
            })}
          >
      ...
      <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30">
        ...
        <CardContent className="relative p-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-2 textbg ">Book Appointment</h3>
