...
import { getUserAppointments } from '@/lib/ServerActions/appointments';
...
async function NextAppointment() {
  ...
  return (
    <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-background font-[Harmattan]">
      <CardHeader>
        <CardTitle className="flex items-center gap-2 textbg ">
      ...
      <CardContent className="space-y-4">
        {/* Status Badge */}
        <div className="flex items-center justify-between font-[Harmattan]">
