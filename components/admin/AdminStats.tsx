...
import { Calendar, Clock1, UserCheck, Users2 } from 'lucide-react';
...
const AdminStats = ({  activeDoctors,
  totalDoctors,
  completedAppointments,
  totalAppointments,}:AdminStatsProps) => {
  return (
         <div className="grid md:grid-cols-4 gap-6 mb-12  font-[Harmattan]">
