...
function WelcomeSection() {
  return (
    <div className="z-10 font-[Harmattan] flex items-center justify-between bg-gradient-to-br from-primary/10 via-primary/5 to-background rounded-3xl p-8 border border-primary/20 mb-12 overflow-hidden">
